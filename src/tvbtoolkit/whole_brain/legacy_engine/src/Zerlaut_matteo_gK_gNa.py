from . import Zerlaut_gK_gNa
from tvb.simulator.models.base import numpy
from numba import jit

class Zerlaut_adaptation_first_order(Zerlaut_gK_gNa.Zerlaut_adaptation_first_order):
    ...
    def get_fluct_regime_vars(Fe, Fi, Fe_ext, Fi_ext, W, Q_e, tau_e, E_e, Q_i, tau_i, E_i, g_K, g_Na, C_m, E_K, E_Na, N_tot, p_connect_e,p_connect_i, g, K_ext_e, K_ext_i):
        ...
        mu_G = (g_K+g_Na)+mu_Ge+mu_Gi  # Eqns 6 from [MV_2018]
...
class Zerlaut_adaptation_second_order_gK_gNa(Zerlaut_gK_gNa.Zerlaut_adaptation_second_order):
