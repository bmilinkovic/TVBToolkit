...
python notebooks/06_pci_analysis_pub.py \
  --sim-pci-root "${CNRS_ROOT}/data_doc_liege/results/notebooks_outputs/ba_sim_hybrid/condition_b/sims_pci" \
  --output-dir "${CNRS_ROOT}/data_doc_liege/results/notebooks_outputs/06_pci_condition_b" \
  "$@"
